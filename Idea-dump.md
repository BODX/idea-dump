...
Send these materials to schools, employers, etc...
...
## Our Q&A
Quora-like Q&A system for closed discussion. Maybe circle of friends/fb lists as recipients, instead of email over and over again.
...
Humans are idiots. When we screw up, there needs to be an emergency system in place to put an immediate halt to whatever scrupulous and devastating shit we pull (e.g. fracking)
...
Create a human benefit codex that everyone has to adhere to. This includes corporations who are persons by law as well, except that they only holds liable to its stockholders (but should be to all stakeholders). 
...
Create a new releases app that let's you pull in your favorite bands (last.fm, Spotify top listens, iTunes library, manually add) and add a list to your Spotify account. Later on add more sources and play spotify inside the app. Get new albums from Amazon and reference with Spotify. 

Create an auto-transcribe service. start with manual transcription. user can record his own stop/go command (mic listening in - check battery consumption).
Part of seamless voice recording app. 

Create a service to remind you to call/chat with important people in our lives. Hook into address book, email, recent calls and social networks. Find a time in the calendar. 
...
UXify social good - Make having an impact on the world easy. Find things that immediately improve your life _and_ be good for the world. Could be basic questions: ‘Do you want to save money or have an impact?’.

Do a real-life Pacman game

Horror Mobile - Displays scary shadows onto the walls

Noise - record 1 second audio messages. Hear a noise wall of random sounds. 
...
Create a Champaigne 'Analwasser', 'Arschwasser', 'Popöchen' (Piccolos)

App that lets you record people around you and add the sound to videos or gifs of random douchebags. 

Create an app for entrepreneur speed dating

Create a bottle out of durable and lightweight glass

Bahn prank:
Make a couple of fake videos portraying people on the can on the train. Conveying funny things as well like shaving, making faces, fucking.
Social media shitstorm campaign. Check w/ lawyers if we must pusblish on April 1st. 

Social exchange idea:
...
Create an armband just like Fitbit but for Withings’ Healthmate
...
Independent service for sticking to only private hosting and sharing mechanisms. Bringing together the frontend and sharing capabilities that make dropbox and the like so versatile, especially on mobile. integration into other services is a killer. 

Create 2D glasses for 3D cinemas.

Make an app to create a photo book of your Facebook timeline.

Make a better version of lighter fluid refiller.

Platform for little ideas. One could pitch e. g. a great idea for a poster design made from a certain movie or picture. The rights would be split 50/50 (?). 
tiny pitch(er)
...
Make good cables
Question to Quora: How to make a good (say) USB 3, micro-USB or Lightning cable? 
I try to learn everything that is a key factor to a good experience with the cable. Like built quality, speed, easy connectivity, 'bendiness' of the cable, storage capabilities  and whatever people find important or annoying.
Another aspect is how to create a cable that holds up and how to make sure it get’s built to last.

Create an open (source kinda) Shazam. An open call to all musicians to submit their music to be recognized in the service.

Food delivery service that let's the user submit/choose recipes from all over the web.

[Legacy] A dying man’s spite
Set up a support network/secret society helping dying people find a purpose by selecting and killing bad people. 
